...
const heap = new Array(25600).fill(undefined);
...
/**
 * @param {Uint8Array} dkg_first_round_output
 * @returns {Uint8Array}
 */
module.exports.hello_wasm = function(dkg_first_round_output) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(dkg_first_round_output, wasm.__wbindgen_malloc);
...
const memory = new WebAssembly.Memory({
    ...
    maximum: 512  // Optional: up to 32MB (512 * 64KB)
});
// imports.env = {memory};
