...
impl ValidatorConfigBuilder {
    ...
    pub fn build(
        ...
        NodeConfig {
            dwallet_mpc_class_groups_decryption_share: validator.dwallet_mpc_class_groups_decryption_share,
            dwallet_mpc_class_groups_public_parameters: validator.dwallet_mpc_class_groups_public_parameters,
...
impl FullnodeConfigBuilder {
    ...
    pub fn build<R: rand::RngCore + rand::CryptoRng>(
        ...
        NodeConfig {
            dwallet_mpc_class_groups_decryption_share: validator_config.dwallet_mpc_class_groups_decryption_share,
            dwallet_mpc_class_groups_public_parameters: validator_config.dwallet_mpc_class_groups_public_parameters,
            max_active_dwallet_mpc_instances: DEFAULT_MAX_ACTIVE_DWALLET_MPC_INSTANCES,
